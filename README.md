...
* The product must effectively trust it when using third-party functionality, such as a web widget, library, or other source of functionality. Without proper protective techniques, the feature could be harmful (either from an untrusted source, faked, or modified in transit from a trusted source). 
